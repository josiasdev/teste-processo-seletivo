...
CREATE TABLE despesas4trimestre2022 (
...
INSERT INTO despesas4trimestre2022 (operadora, descricao_evento, total_despesas)
SELECT 
...
select * from despesas4trimestre2022;