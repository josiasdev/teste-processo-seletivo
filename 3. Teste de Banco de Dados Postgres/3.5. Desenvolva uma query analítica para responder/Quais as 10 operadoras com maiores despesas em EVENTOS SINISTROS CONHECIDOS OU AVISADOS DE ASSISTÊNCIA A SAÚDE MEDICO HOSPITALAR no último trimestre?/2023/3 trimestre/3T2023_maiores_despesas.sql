...
CREATE TABLE despesas3trimestre2023 (
...
INSERT INTO despesas3trimestre2023 (operadora, descricao_evento, total_despesas)
SELECT 
...
select * from despesas3trimestre2023;