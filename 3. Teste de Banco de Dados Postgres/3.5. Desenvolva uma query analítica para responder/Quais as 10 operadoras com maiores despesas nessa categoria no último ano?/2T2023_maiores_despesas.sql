...
CREATE TABLE despesas2trimestre2023 (
...
INSERT INTO despesas2trimestre2023 (operadora, descricao_evento, total_despesas)
SELECT 
...
select * from despesas2trimestre2023;